...
# For each PS1 file found in script directory...
foreach ($file in (Get-ChildItem $("{0}\_*.ps1" -f $($MyScript.Directory).TrimEnd('\')) -File)) {
...
<#
------------------------------------------------------------------------------------------
Replace the previous foreach loop by the following to use protected "resource" files.
------------------------------------------------------------------------------------------
# For each PSL file found in script directory...
